...
object RawModule {
    ...
    @Named("options_user")
    @Provides
    fun provideUserOptions(context: Context): MutableList<ListItem> =
        JsonUtil.parseToList(context, R.raw.options_user)

    @Named("options_group")
    @Provides
    fun provideGroupOptions(context: Context): MutableList<ListItem> =
        JsonUtil.parseToList(context, R.raw.options_group)

    @Named("options_subject")
    @Provides
    fun provideSubjectOptions(context: Context): MutableList<ListItem> =
