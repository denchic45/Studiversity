...
class EventEditorInteractor : Interactor {
    private var editedEvent = PublishSubject.create<Resource<Pair<Event, String>>>()
    ...
    fun observeEvent(): Observable<Resource<Pair<Event, String>>> {
    ...
    fun postEvent(event: Resource.Success<Pair<Event, String>>) {
