package com.denchic45.kts.ui.adminPanel.timtableEditor.loader.lessonsOfDay
...
import com.denchic45.kts.ui.adapter.OnItemTouchListener
import com.denchic45.kts.ui.base.listFragment.ListFragment
import java.util.*

//TODO НЕ ПЕРЕДАВАТЬ СЛУШАТЕЛИ ЧЕРЕЗ КОНСТРУКТОР!!!
class LessonsOfDayFragment(
) : ListFragment<EventAdapter>() {
