package com.denchic45.kts.ui.adminPanel.timtableEditor.eventEditor.lessonEditor
...
class LessonEditorViewModel @Inject constructor(
    ...
    fun onSubjectClick() {
        ...
        choiceOfSubjectInteractor.groupUuid = interactor.oldEvent.value!!.group.uuid
