...
import com.denchic45.studiversity.database.table.ExternalStudyGroupsMemberships
import com.denchic45.studiversity.database.table.Memberships
...
class MembershipRepository(private val realtime: Realtime, private val coroutineScope: CoroutineScope) {
    ...
    fun findScopeIdByMembershipId(membershipId: UUID): UUID = transaction {
        Memberships.slice(Memberships.scopeId).select(Memberships.id eq membershipId)
            .single()[Memberships.scopeId].value
    }
